...
2. **No real floor-plan coordinates exist.** `public.devices.location` holds
   5 coarse zone labels only: `Factory 2 - DF INNER`, `Factory 2 - DF OUTER`,
   `Factory 2 - SM`, `Factory 3 - DF INNER`, `Factory 3 - SM`. There is no
...
'24 hours' GROUP BY eqp_id` returns exactly `LDI-01`..`LDI-10`. The other
   13 (`LDI_01` legacy, `LDI001-LD1/LD2`, `LDI002-LD1/LD2`, `EXPOSURE LDI-2`,
   `EXPOSURE LDI-2B`, `LDI-C-01/02`, `LDIA-01/02`, `LDIA3-SM-LDI1/2`) are

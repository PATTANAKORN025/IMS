...
| `GET /factory-twin-3d/api/state` | Real JSON, 23 devices returned (`EXPOSURE LDI-2`, `EXPOSURE LDI-2B`, `LDI-01..10`, `LDI-C-01/02`, `LDI001-LD1/2`, `LDI002-LD1/2`, `LDIA-01/02`, `LDIA3-SM-LDI1/2`, `LDI_01`), 10 with real telemetry (`state_label: "OK"`/`"ALARM"`), 13 correctly `NO_DATA` — matches the known, disclosed 10/23 real-telemetry gap exactly |

...
`docs/evidence/runtime/production-assurance-*.json` report as PRODUCTION-READINESS.md (profile: `security`, 2026-08-24T07:40:38.485Z) -- no new tests here, this is a cross-cutting view over the same results.

...
**Files:**
- Modify: `monitoring/snmpsim/apex_mock.snmprec` (lines 31-37)
...
```bash
Get-Content monitoring\snmpsim\apex_mock.snmprec
```
...
Edit `monitoring/snmpsim/apex_mock.snmprec` — replace lines 31-37:

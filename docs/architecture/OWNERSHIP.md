...
| **Dashboards**     | `monitoring/grafana/dashboards/infrastructure/` (5 dashboards, Grafana folder "IMS Infrastructure")                                                                                                   | `monitoring/grafana/dashboards/manufacturing/` (9 dashboards, Grafana folder "IMS Manufacturing")                                                                       |

...
<img src="../assets/icons/check-circle.svg" width="14" align="center"/> **ขนาดที่รองรับ:** เครื่องจักร 1-1000+ เครื่อง
<img src="../assets/icons/check-circle.svg" width="14" align="center"/> **ปัจจุบัน:** ทดสอบแล้วที่ 1K VUs
<img src="../assets/icons/check-circle.svg" width="14" align="center"/> **ขีดจำกัดสูงสุด:** ~500 เครื่อง
...
7. [ความถูกต้องของข้อมูลและการจัดการการขยายระบบ (รายละเอียดทางสถาปัตยกรรม) (Data Fidelity & Scale Management (Architectural Details))](../architecture/DATA_FIDELITY_AND_SCALING-th.md)

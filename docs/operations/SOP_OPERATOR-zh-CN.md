...
- `> 95%`: <img src="../assets/icons/check-circle.svg" width="14" align="center"/> **Status:** Healthy 正常。继续日常工作。
- `90% - 94%`: <img src="../assets/icons/check-circle.svg" width="14" align="center"/> **Status:** Warning 警告。检查 "Top 10 Critical Nodes" 面板。
...
### <img src="../assets/icons/check-circle.svg" width="14" align="center"/> **Status:** Healthy 绿灯状态 (正常)

- **视觉:** 所有面板呈绿色。无闪烁。
- **操作:** 无需操作。继续常规机器上下料。

### <img src="../assets/icons/check-circle.svg" width="14" align="center"/> **Status:** Warning 黄灯状态 (警告)

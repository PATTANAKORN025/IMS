...
2. **Verify Fleet Health Score** (Top Left panel):
   - `> 95%`: <img src="../assets/icons/check-circle.svg" width="14" align="center"/> **Status:** Healthy **Nominal**. Accept shift.
   - `90% - 94%`: <img src="../assets/icons/check-circle.svg" width="14" align="center"/> **Status:** Warning **Warning**. Check the "Top 10 Critical Nodes" panel. Request verbal briefing from outgoing shift regarding these nodes.
   - `< 90%`: <img src="../assets/icons/check-circle.svg" width="14" align="center"/> **Status:** Critical **Critical**. Do not accept shift without L2 (Engineering) presence. Escalate immediately.
...
### <img src="../assets/icons/check-circle.svg" width="14" align="center"/> **Status:** Healthy Green State (Nominal Operation)
...
### <img src="../assets/icons/check-circle.svg" width="14" align="center"/> **Status:** Warning Yellow State (Pre-emptive Warning)
...
### <img src="../assets/icons/check-circle.svg" width="14" align="center"/> **Status:** Critical Red State (Critical Excursion / Stop Line)

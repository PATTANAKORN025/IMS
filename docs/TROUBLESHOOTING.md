...
# Network testing
docker exec ims-node-red node -e "const snmp=require('net-snmp'); const s=snmp.createSession('ims-snmpsim','apex_mock'); s.get(['1.3.6.1.2.1.1.1.0'],(e,v)=>{console.log(e?e.message:v[0].value.toString()); s.close()});"
```

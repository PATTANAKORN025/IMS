...
BEGIN
    ...
    FOR i IN 0..1439 LOOP
        ...
        FOR m IN 1..4 LOOP
            ...
            -- ANOMALY: LDI-A06 thermal drift between hour 20-21 (NOW-4h to NOW-3h)
            IF eqp = 'LDI-A06' AND i >= 1200 AND i < 1260 THEN
            ...
            -- PE values: normal ±2, anomaly LDI-A06 drifts to ±25
            pe_s := pe_base * 0.3;
            je_s := pe_base * 0.15;
            ...
            -- Insert correlated alarms for LDI-A06 during thermal drift
            IF eqp = 'LDI-A06' AND i >= 1200 AND i < 1260 AND (i - 1200) % 10 = 0 THEN
            ...
            IF eqp = 'LDI-A06' AND i >= 1200 AND i < 1260 AND temp_base > 24.5 AND (i - 1200) % 5 = 0 THEN
                INSERT INTO public.ldi_alarm_log (
                    logid, logdate, errorcode, errortime, equipmentid, factory, process
                ) VALUES (
                    gen_random_uuid()::VARCHAR, t,

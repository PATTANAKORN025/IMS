...
- [ ] **Step 2: จัดวางพื้นที่สร้างรูปสี่เหลี่ยมผืนผ้ากรอบแสดงป้ายพื้นหลังพื้นที่กำหนดโซน 5 อัน — โดยดึงจากข้อมูลในช่องข้อความ string ค่าจริงที่มาจากระบบสถานที่อย่าง `public.devices.location`, ที่ซึ่งมีผลจากการสแกนตรวจพบแล้ว 2026-08-17: ว่ามี `Site A - Zone 1`, `Site A - Zone 2`, `Site A - Zone 3`, `Site B - Zone 1`, `Site B - Zone 2`**

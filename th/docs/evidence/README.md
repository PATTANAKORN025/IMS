...
# <img src="../../../docs/assets/icons/folder.svg" width="18" align="center" /> เอกสารหลักฐาน (Evidence Documentation)

ยินดีต้อนรับสู่ไดเรกทอรี **Evidence** ส่วนนี้ประกอบด้วยเอกสารที่เกี่ยวข้องกับกระบวนการจัดการหลักฐานของ IMS

## <img src="../../../docs/assets/icons/map.svg" width="18" align="center" />️ แผนผังไดเรกทอรี (Directory Map)

```mermaid
%%{init: {'theme': 'base', 'themeVariables': { 'primaryColor': '#1e293b', 'primaryTextColor': '#00F2FE', 'primaryBorderColor': '#10B981', 'lineColor': '#00F2FE', 'secondaryColor': '#0f172a', 'tertiaryColor': '#0f172a', 'clusterBkg': '#030407', 'clusterBorder': '#00F2FE'}}}%%
flowchart LR
  ROOT["docs/evidence"]
  ROOT --> F0["ALARM_LATENCY_MEASUREMENT_NOTE"]
  ROOT --> F1["DATA_INTEGRITY_VALIDATION_2026-08-15"]
  ROOT --> F2["DR_DRILL_3_FINDINGS"]
  ROOT --> F3["EVIDENCE_PACK"]
  ROOT --> F4["FAULT_INJECTION_PLAN"]
  ROOT --> F5["FINAL_ACCEPTANCE_MATRIX_2026-08-15"]
  ROOT --> F6["HISTORICAL_DATA_RECONCILIATION_2026-08-15"]
  ROOT --> F7["INDEX"]
  ROOT --> F8["SCALE_TEST_2026-08-15"]
  ROOT --> F9["SOAK_TEST_LOG"]
  ROOT --> F10["SYSTEM_TRUST_REPORT"]

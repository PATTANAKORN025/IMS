...
> [!NOTE]
>
> > ไดอะแกรมเหล่านี้ถูกสร้างขึ้นแบบไดนามิกโดยใช้ Mermaid.js ซึ่งให้ภาพรวมเชิงโครงสร้างของระบบนิเวศ IMS ในรูปแบบวิชวล

---

## 1. System Context Diagram (C4 Model - Level 1)

ไดอะแกรมนี้แสดงให้เห็นว่าผู้มีส่วนเกี่ยวข้องภายนอก (External actors) โต้ตอบกับระบบ IMS อย่างไร
...
ไดอะแกรมนี้แบ่งระบบ IMS ออกเป็นคอนเทนเนอร์ Docker ที่สามารถปรับใช้ได้ (Deployable Docker containers)
...
ไดอะแกรมนี้อธิบายกลไกความทนทานต่อข้อผิดพลาด (Fault-tolerance mechanism) เมื่อเซิร์ฟเวอร์ออฟไลน์

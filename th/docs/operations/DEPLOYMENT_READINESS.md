...
<img src="../../../docs/assets/icons/check-circle.svg" width="14" align="center"/> **สถานะ:** พร้อมสำหรับใช้งานบน Production
<img src="../../../docs/assets/icons/check-circle.svg" width="14" align="center"/> **เวอร์ชัน:** 1.0.0
<img src="../../../docs/assets/icons/check-circle.svg" width="14" align="center"/> **ประเมินล่าสุด:** 2026-06-29
...
| ---------------------------- | ------------------------------------------- | -------------------------- | ------------------------------------------------------------------------------------------------------------- | ----------------------- |
| **Ubuntu (SNMP)**            | MIB มาตรฐาน                                 | HOST-RESOURCES-MIB         | <img src="../../../docs/assets/icons/check-circle.svg" width="14" align="center"/> **สถานะ:** แข็งแรง สูง (Healthy HIGH) | มีแนวโน้มสูงที่จะตรงกัน |
| **Windows (SNMP)**           | MIB มาตรฐาน                                 | HOST-RESOURCES-MIB         | <img src="../../../docs/assets/icons/check-circle.svg" width="14" align="center"/> **สถานะ:** แข็งแรง สูง (Healthy HIGH) | มีแนวโน้มสูงที่จะตรงกัน |

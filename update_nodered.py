...
with open('nodered_data/flows.json', 'r') as f:
    flows = json.load(f)
...
# Write the modified flows.json back to file
with open('nodered_data/flows.json', 'w') as f:
    json.dump(flows, f, indent=4)

print('Function node code updated successfully')

...
icons = [
    'bug', 'wrench', 'activity', 'check-circle', 'image', 'bar-chart',
    'server', 'file-text', 'lightbulb', 'rocket', 'layers', 'clock',
    'shield', 'briefcase', 'factory', 'users', 'globe', 'trending-up', 'refresh-cw'
]

...
const EXEMPT_FILES = new Set([
  ...
  'docs/DOC_AUDIT_GAP_REPORT.md', // this report; quotes stale text as evidence of what was found
  'docs/DOCUMENTATION_QUALITY_REPORT.md', // quotes a past bug's exact wrong text as the record of the fix

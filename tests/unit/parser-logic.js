...
function parseAll(items, type, state) {
    ...
    for (const item of items) {
        ...
        if (type === 'cpu' && (oid.startsWith('1.3.6.1.2.1.25.3.3.1.2.') || oid.startsWith('1.3.6.1.4.1.2636.3.1.13.1.8.'))) { if (Number.isFinite(numVal) && numVal > 0) { cpu.total += numVal; cpu.count++; } continue; }

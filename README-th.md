...
<div align="center">
  <blockquote style="border-left: 4px solid #00F2FE; background: rgba(0, 242, 254, 0.05); padding: 16px; border-radius: 8px;">
    <b style="font-size: 18px;">ระบบโทรมาตรความแม่นยำสูงสำหรับการผลิตและควบคุมกระบวนการทางสถิติ</b><br/>
    <i style="color: #10B981;">สถาปัตยกรรม Digital Twin แบบไร้รอยต่อสำหรับโหนด 1,000+</i>
  </blockquote>
</div>

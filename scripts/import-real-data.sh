...
#      log, never in the telemetry export (LDI-B05, LDI-B06,
#      LDI-B07) -- confirmed genuinely distinct from the already-
#      registered LDI-B01/LD2 by non-overlapping... actually
...
VALUES
    ('LDI-B05', 'ldi-b05',    'Site B - Zone 1', 'ldi', true, 'public', 161),
    ('LDI-B06', 'ldi-b06',    'Site B - Zone 1', 'ldi', true, 'public', 161),
    ('LDI-B07',     'ldi-b07', 'Site B - Zone 1', 'ldi', true, 'public', 161)
